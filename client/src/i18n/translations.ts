...
export const translations: Record<Locale, any> = {
  en: {
    ...
    auth: {
      ...
      magicSent: "Magic link sent. Check your inbox and spam folder.",
      magicMissingAccount: "No account was found for this email. Use Sign up first or enter a registered email.",
  ...
  fr: {
    ...
    auth: {
      ...
      magicSent: "Lien magique envoyé. Vérifiez votre boîte de réception et les spams.",
      magicMissingAccount: "Aucun compte n'est associé à cet email. Inscrivez-vous d'abord ou utilisez un email enregistré.",
  ...
  ar: {
    ...
    auth: {
      ...
      magicSent: "تم إرسال الرابط. تحقق من صندوق الوارد والرسائل غير المرغوبة.",
      magicMissingAccount: "لا يوجد حساب مرتبط بهذا البريد. أنشئ حساباً أولاً أو استخدم بريداً مسجلاً.",
